...
public class VariousAchievementsVariables {
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "variousachievementsplus_worldvars";
		public boolean vapStatus = false;
		...
		@Override
		public void readFromNBT(NBTTagCompound nbt) {
			vapStatus = nbt.getBoolean("vapStatus");
		}

		@Override
		public NBTTagCompound writeToNBT(NBTTagCompound nbt) {
			nbt.setBoolean("vapStatus", vapStatus);
			return nbt;
		}
